	...
	char str1[] = "                                S J C Institute of Technology";
	...
	char str8[] = "SHRAVYA M R - 1SJ16CS096";
	char str9[] = "SHREEHARI B V - 1SJ16CS097";
	char str10[] = "Submitted To:";
	char str11[] = "MR. SRINATH G M";
	char str12[] = "Asst. Prof";
	char str13[] = "********************************************* MENU *********************************************";
